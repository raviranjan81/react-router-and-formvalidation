            ...
            <div className="text-red-600 py-3 font-semibold">
              ...
              <div>
                ...
                <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                  type="text" placeholder="" name='name' value={values.name} onChange={handleChange}/>
              </div>
              <div class="mt-8">
              ...
              <div class="mt-8">
                ...
                <textarea
                  class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name='message' onChange={handleChange} value={values.message} ></textarea>
              </div>
              <div class="mt-8">
                <button
